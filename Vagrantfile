...
Vagrant.configure("2") do |config|
  ...
  config.vm.define "webserver" do |webserver|
	# Options specific to webserver VM
  ...
  # Private Network for VMs to communicate
...
config.vm.define "dbserver" do |dbserver|
  ...
  # Setting up administrator web interface
  config.vm.define "adminwebserver" do |webserver|
	# Options specific to adminwebserver VM
	webserver.vm.hostname = "adminwebserver"
